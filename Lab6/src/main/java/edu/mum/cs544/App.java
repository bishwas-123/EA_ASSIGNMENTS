...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //f where f.airplane.getCapacity()>500
        List<Flight> flights = em.createQuery("Select f from Flight as f where f.airplane.capacity>500", Flight.class).getResultList();
        ...
        List<Airline> airlines = em.createQuery("Select distinct a from Airline as a JOIN a.flights as af where af.airplane.model='A380'", Airline.class).getResultList();
        ...
        TypedQuery<Flight> query = em.createQuery("Select f from Flight f where f.departureDate='2009/08/07' AND HOUR(f.departureTime)<12 ", Flight.class);
